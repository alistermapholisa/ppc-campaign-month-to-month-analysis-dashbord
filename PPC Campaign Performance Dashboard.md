...
3. Paste the contents of `ppc-dashboard-snippet.html`
4. Publish
...
1. Collect campaign data from your advertising platforms (Facebook Ads Manager, Google Ads, etc.)
2. Calculate metrics using the formulas provided
3. Edit `data.json` in your GitHub repository
4. Add your new campaign data to the beginning of the `campaigns` array
5. Commit changes with a descriptive message
6. The dashboard will automatically refresh and display new data
...
- Does the `data.json` file have valid JSON syntax? (Test at [JSONLint.com](https://www.jsonlint.com/))
...
- **Elementor**: Visit [Elementor Help](https://elementor.com/help/)
- **Chart.js**: Visit [Chart.js Docs](https://www.chartjs.org/docs/latest/)
